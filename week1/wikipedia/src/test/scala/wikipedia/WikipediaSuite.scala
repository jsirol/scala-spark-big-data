...
//  test("own test 1") {
//    val vals = Set(
//      ("MATLAB",0), ("PHP",1), ("Java",2), ("Perl",0), ("Ruby",0), ("Haskell",0),
//      ("JavaScript",2), ("Groovy",0), ("C#",1), ("Objective-C",0), ("Python",1),
//      ("Scala",0), ("C++",1), ("Clojure",0), ("CSS",0))
//
//    import WikipediaRanking._
//    val langs = WikipediaRanking.langs
//    val res = rankLangs(langs, WikipediaRanking.wikiRdd)
//    val res2 = WikipediaRanking.rankLangsReduceByKey(langs, WikipediaRanking.wikiRdd)
//    assert(res === res2)
//  }
